...
//    @Query("DELETE FROM height_weight_measurement_meta")
//    fun nukeTable(): Int
//
//    @Insert(onConflict = OnConflictStrategy.REPLACE)
//    fun insert(bodyMeasurementMeta: HeightWeightMeasurementMeta): Long
//
//    @Delete
//    fun delete(bodyMeasurementMeta: HeightWeightMeasurementMeta)
//
//    @Query("DELETE FROM height_weight_measurement_meta WHERE id = :id")
//    fun deleteRequest(id : Long)
//
//    @Query("UPDATE height_weight_measurement_meta SET sync_pending = 0 WHERE sync_pending = 1 AND screening_id = :screeningId")
//    fun update(screeningId: String): Int
//
//
//    @Query("SELECT * FROM height_weight_measurement_meta WHERE id = :id")
//    fun getBodyMeasurementMeta(id: Long): LiveData<HeightWeightMeasurementMeta>
//
//    @Query("SELECT * FROM height_weight_measurement_meta")
//    fun getBodyMeasurementMetas(): LiveData<List<HeightWeightMeasurementMeta>>
//
//    @Query("SELECT * FROM height_weight_measurement_meta WHERE screening_id=:screeningId ORDER BY id DESC LIMIT 1")
//    fun getBodyMeasurementMetas(screeningId: String): LiveData<HeightWeightMeasurementMeta>
//
//    @Query("SELECT * FROM height_weight_measurement_meta WHERE sync_pending = 1 ORDER BY id ASC")
//    fun getBodyMeasurementMetasSyncPending(): LiveData<List<HeightWeightMeasurementMeta>>
