package org.singapore.ghru.ui.checkout.voucherdetails.manualentry
...
class ManualEntryVoucherFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryVoucherViewModel
