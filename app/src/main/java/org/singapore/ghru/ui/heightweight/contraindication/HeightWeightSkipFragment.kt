...
import org.singapore.ghru.databinding.HeightAndWeightSkipFragmentBinding
...
class HeightWeightSkipFragment : DialogFragment() {

    val TAG = HeightWeightSkipFragment::class.java.getSimpleName()

    var binding by autoCleared<HeightAndWeightSkipFragmentBinding>()

    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)

    @Inject
    lateinit var viewModel:HeightWeightSkipViewModel
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<HeightAndWeightSkipFragmentBinding>(
            inflater,
            R.layout.height_and_weight_skip_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(HeightWeightSkipViewModel::class.java)
