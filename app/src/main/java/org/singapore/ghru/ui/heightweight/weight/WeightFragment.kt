...
import org.singapore.ghru.databinding.BodyCompositionFragmentBinding
import org.singapore.ghru.databinding.WeightFragmentBinding
...
import org.singapore.ghru.ui.bodymeasurements.bodycomposition.reason.ReasonDialogFragment
...
class WeightFragment : Fragment(), Injectable {
    @Inject
    ...
    var binding by autoCleared<WeightFragmentBinding>()
    ...
    //private lateinit var bodyMeasurementData: HeightWeightMeasurementData
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<WeightFragmentBinding>(
            inflater,
            R.layout.weight_fragment,
            container,
            false
        )
        binding = dataBinding
...
//            bodyMeasurementValueMuscle.value = "30.1"
        ...
        viewModel.setStationName(Measurements.weight)
...
//                        )
                        ...
                        bodyMeasurementData.unit = "kg"
                        bodyMeasurementData.value = bodyMeasurementValue.value.toDouble()
