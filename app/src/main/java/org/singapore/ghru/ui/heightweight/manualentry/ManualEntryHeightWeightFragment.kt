package org.singapore.ghru.ui.heightweight.manualentry
...
class ManualEntryHeightWeightFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryHeightWeightViewModel
