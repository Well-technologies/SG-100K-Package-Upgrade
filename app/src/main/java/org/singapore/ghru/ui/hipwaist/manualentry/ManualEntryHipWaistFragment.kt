package org.singapore.ghru.ui.hipwaist.manualentry
...
class ManualEntryHipWaistFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryHipWaistViewModel
