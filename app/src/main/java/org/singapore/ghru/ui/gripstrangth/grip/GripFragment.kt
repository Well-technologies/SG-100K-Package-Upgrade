package org.singapore.ghru.ui.gripstrangth.grip
...
import org.singapore.ghru.databinding.GripFragmentBinding
...
class GripFragment : Fragment(), Injectable {
    @Inject
    ...
    var binding by autoCleared<GripFragmentBinding>()
    ...
    @Inject
    lateinit var viewModel: GripViewModel
    ...
    private var reading1: GripStrengthData? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            reading1 = arguments?.getParcelable<GripStrengthData>("Reading1")!!
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<GripFragmentBinding>(
            inflater,
            R.layout.grip_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.buttonSubmit.singleClick {
            ...
            if (validateGripReading1(binding.hipR1EditText.text.toString()) && validateGripReading2(binding.hipR2EditText.text.toString()))
            {
                ...
                LeftGripRecordTestRxBus.getInstance().post(record)
                binding.root.hideKeyboard()
            ...
            else if (validateGripReading1(binding.hipR1EditText.text.toString()) && !validateGripReading2(binding.hipR2EditText.text.toString()))
            {
                ...
                {
                    val missingDialogFragment = ReadingOneMissingDialogFragment()
                    missingDialogFragment.arguments = bundleOf(
                        "readingOneData" to record)
...
//                if (validateGripReading1(binding.hipR1EditText.text.toString()) || validateGripReading2(binding.hipR2EditText.text.toString()))
//                {
////                val leftList:ArrayList<String> = arrayListOf()
////                leftList.add(binding.hipR1EditText.text.toString())
////                leftList.add(binding.hipR2EditText.text.toString())
////                leftList.add(binding.hipR3EditText.text.toString())
//                    if (validateGripReading1(binding.hipR1EditText.text.toString()))
//                    {
//                        reading_1 = GripStrengthReading(value = binding.hipR1EditText.text.toString(), unit = "kg")
//                    }
...
//                        right_grip = reading_2)
//
//                    Log.d("GRIP_FRAGMENT","DATA: " + record)
//
