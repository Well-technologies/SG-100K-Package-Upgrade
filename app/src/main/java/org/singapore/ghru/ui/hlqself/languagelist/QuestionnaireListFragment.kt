...
import org.singapore.ghru.databinding.QuestionnaireListFragmentBinding
import org.singapore.ghru.databinding.QuestionnaireSelfListFragmentBinding
...
class QuestionnaireListFragment : Fragment(), Injectable, SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.languageSelf?.observe(this, Observer { resource ->
