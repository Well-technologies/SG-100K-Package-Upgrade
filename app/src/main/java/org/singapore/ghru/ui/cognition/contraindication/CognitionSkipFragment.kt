...
import org.singapore.ghru.databinding.CognitionSkipFragmentBinding
...
class CognitionSkipFragment : DialogFragment() {

    val TAG = CognitionSkipFragment::class.java.getSimpleName()

    var binding by autoCleared<CognitionSkipFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<CognitionSkipFragmentBinding>(
            inflater,
            R.layout.cognition_skip_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(CognitionQuestionnaireViewModel::class.java)
