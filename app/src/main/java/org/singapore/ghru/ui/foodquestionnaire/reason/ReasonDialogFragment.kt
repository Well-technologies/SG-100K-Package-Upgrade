package org.singapore.ghru.ui.foodquestionnaire.reason
...
class ReasonDialogFragment : DialogFragment(), Injectable {
    ...
    var binding by autoCleared<FfqReasonDialogFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<FfqReasonDialogFragmentBinding>(
            inflater,
            R.layout.ffq_reason_dialog_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        cancelRequest = CancelRequest(stationType = "food-frequency")
