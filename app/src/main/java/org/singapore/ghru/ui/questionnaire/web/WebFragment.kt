package org.singapore.ghru.ui.questionnaire.web
...
import org.singapore.ghru.databinding.WebFragmentBinding
import org.singapore.ghru.db.MemberTypeConverters
import org.singapore.ghru.di.Injectable
import org.singapore.ghru.jobs.SyncSurveyJob
import org.singapore.ghru.sync.SyncResponseEventType
import org.singapore.ghru.sync.SyncServeyRxBus
...
import org.singapore.ghru.util.fromJson
...
class WebFragment : Fragment(), Injectable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val partiJson : String? = prefs?.getString("ParticipantRequest","")
            val queJson : String? = prefs?.getString("Questionnaire","")
            participant = MemberTypeConverters.gson.fromJson<ParticipantRequest>(partiJson.toString())
            questionnaire = MemberTypeConverters.gson.fromJson<Questionnaire>(queJson.toString())
...
//            questionnaire = arguments?.getParcelable<Questionnaire>("Questionnaire")!!
            questionareJson = questionnaire?.url!!
...
//                navController().navigate(R.id.action_WebFragment_to_ConfirmFragment, bundle)
//
//                //activity!!.finish()
...
//        viewModel.getQuestionnaire(network =  isNetworkAvailable(), language = "en")
        ...
        //binding.webView.settings!!.setLayoutAlgorithm(WebSettings.LayoutAlgorithm.SINGLE_COLUMN)
...
//                    Log.d("WEB_FRAGMENT", "URL" + url + ", JSON: " + questionareJson)
//                    binding.webView.loadUrl("javascript:init(" + questionareJson + ")")
//                    //binding.webView.loadUrl("https://nhealth-staging-sg-276511.df.r.appspot.com/survey/c5e9f540-f70d-11ea-b35e-1db563b0eaa9/get/PXY-0188-3")
//                }

//                if (participant?.screeningId != null)
//                {
//                    val webUrl = questionareJson + "/" + participant?.screeningId
...
//            }
    ...
    private fun errorDialog()
    {
        ...
        builder.setMessage(getString(R.string.error_complete))
        builder.setIcon(getDrawable(activity!!, R.drawable.ic_circular_cross))
