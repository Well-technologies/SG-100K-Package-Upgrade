package org.singapore.ghru.ui.gripstrangth.manualentry
...
class ManualEntryGripStrengthFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryGripStrengthViewModel
