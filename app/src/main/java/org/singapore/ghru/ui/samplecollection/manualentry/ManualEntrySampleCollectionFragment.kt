package org.singapore.ghru.ui.samplecollection.manualentry
...
import org.singapore.ghru.databinding.SamplecollectionManualBarcodeFragmentBinding
...
import org.singapore.ghru.ui.samplecollection.scanbarcode.ScanBarcodeViewModel
            ...
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    ...
                    Navigation.findNavController(activity!!, R.id.container)
                        .navigate(R.id.action_manualParticipent_to_sampleQuestionFragment, bundle)
                }, { error ->
                    print(error)
