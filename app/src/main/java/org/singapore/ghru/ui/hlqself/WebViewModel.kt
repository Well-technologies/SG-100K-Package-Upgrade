...
import org.singapore.ghru.repository.SurveyRepository
...
@Inject constructor(
    ...
    var selfSurvey: LiveData<Resource<ResourceData<CommonResponce>>>? = Transformations
        .switchMap(_survey) { _surveyValue ->
            if (_surveyValue == null) {
                AbsentLiveData.create()
            } else {
                surveyRepository.syncSurveySelf(_surveyValue)
            }
        }
