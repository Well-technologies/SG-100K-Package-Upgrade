package org.singapore.ghru.ui.foodquestionnaire.stageonereason
...
class ReasonDialogFragmentNew : DialogFragment(), Injectable {
    ...
    var binding by autoCleared<FfqReasonDialogFragmentNewBinding>()
...
//            }
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<FfqReasonDialogFragmentNewBinding>(
            inflater,
            R.layout.ffq_reason_dialog_fragment_new,
            container,
            false
        )
        binding = dataBinding
