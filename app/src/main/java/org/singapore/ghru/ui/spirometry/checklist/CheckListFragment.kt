package org.singapore.ghru.ui.spirometry.checklist
...
import org.singapore.ghru.databinding.SpiroCheckListFragmentBinding
import org.singapore.ghru.di.Injectable
import org.singapore.ghru.ui.spirometry.cancelchecklist.CancelDialogFragment
            ...
            if (!isCheckListNotCompleted()) {
                if (!validateContinue()) {
                    findNavController().navigate(
                        R.id.action_CheckListFragment_to_SpiroQueFragment, bundleOf("participant" to participant)
