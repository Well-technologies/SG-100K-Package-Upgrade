package org.singapore.ghru.ui.cognition.manualentry
...
class ManualEntryCognitionFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryCognitionViewModel
        ...
        viewModel.participant.observe(this, Observer { participantResource ->
            ...
            if (participantResource?.status == Status.SUCCESS) {
                ...
                if (!participantResource.data?.stationStatus!!)
                {
                    ...
                    {
                        val statusCheckDialogFragment = StatusCheckDialogFragment()
