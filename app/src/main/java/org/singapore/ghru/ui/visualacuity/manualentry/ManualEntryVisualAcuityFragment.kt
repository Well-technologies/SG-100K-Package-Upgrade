package org.singapore.ghru.ui.visualacuity.manualentry
...
class ManualEntryVisualAcuityFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryVisualAcuityViewModel
        ...
        disposables.add(
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    ...
                    findNavController().navigate(R.id.action_manualFragment_to_visualAidFragment, bundle)
                }, { error ->
                    print(error)
