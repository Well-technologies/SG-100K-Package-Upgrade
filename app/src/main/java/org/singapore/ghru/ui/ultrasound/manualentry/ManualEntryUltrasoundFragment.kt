package org.singapore.ghru.ui.ultrasound.manualentry
...
class ManualEntryUltrasoundFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ManualEntryUltrasoundViewModel
