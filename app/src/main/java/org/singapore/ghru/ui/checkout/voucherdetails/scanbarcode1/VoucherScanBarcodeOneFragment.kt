package org.singapore.ghru.ui.checkout.voucherdetails.scanbarcode1
...
class VoucherScanBarcodeOneFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: VoucherScanBarcodeOneViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        codeScanner.decodeCallback = DecodeCallback {
            activity?.runOnUiThread {
                ...
                {
                    voucherId = it.text
                    prefs?.edit()?.putString("VoucherIDOne", voucherId)?.apply()
...
//        })
        ...
        binding.detailToolbar.title = getString(R.string.checkout_voucher2)
