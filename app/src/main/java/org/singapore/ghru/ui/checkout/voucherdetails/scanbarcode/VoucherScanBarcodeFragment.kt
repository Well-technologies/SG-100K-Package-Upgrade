...
class VoucherScanBarcodeFragment : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: VoucherScanBarcodeViewModel
...
//        })
        ...
        codeScanner.decodeCallback = DecodeCallback {
            activity?.runOnUiThread {
                ...
                {
                    voucherId = it.text
                    prefs?.edit()?.putString("VoucherID", voucherId)?.apply()
...
//        })
        ...
        binding.detailToolbar.title = getString(R.string.checkout_voucher1)
