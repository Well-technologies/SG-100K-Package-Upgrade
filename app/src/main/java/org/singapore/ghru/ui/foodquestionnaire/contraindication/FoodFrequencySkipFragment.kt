...
import org.singapore.ghru.databinding.FfqSkipFragmentBinding
...
class FoodFrequencySkipFragment : DialogFragment() {

    val TAG = FoodFrequencySkipFragment::class.java.getSimpleName()

    var binding by autoCleared<FfqSkipFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<FfqSkipFragmentBinding>(
            inflater,
            R.layout.ffq_skip_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(FoodFrequencyQuestionnaireViewModel::class.java)
