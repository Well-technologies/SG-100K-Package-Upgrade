package org.singapore.ghru.ui.spirometry.cancel
...
import org.singapore.ghru.databinding.SpirometryCancelDialogFragmentBinding
...
class CancelDialogFragment : DialogFragment(), Injectable {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.buttonAcceptAndContinue.text = getString(R.string.app_button_submit_new)
        binding.buttonCancel.text = getString(R.string.app_button_cancel_new)
