package org.singapore.ghru.ui.ecg.scanbarcode
...
import org.singapore.ghru.databinding.EcgScanBarcodePatientFragmentBinding
            ...
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    ...
                    Navigation.findNavController(activity!!, R.id.container)
                        .navigate(R.id.action_scanFragment_to_guideMainFragment, bundle)
                }, { error ->
                    print(error)
