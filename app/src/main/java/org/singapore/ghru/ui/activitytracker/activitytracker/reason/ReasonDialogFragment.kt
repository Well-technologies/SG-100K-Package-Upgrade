package org.singapore.ghru.ui.activitytracker.activitytracker.reason
...
import org.singapore.ghru.databinding.ActivityTrackerDialogFragmentBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.radioGroup.setOnCheckedChangeListener { radioGroup, i ->
            ...
            when (radioGroup.checkedRadioButtonId) {
                R.id.radioButtonFaultyDevice -> cancelRequest.reason = getString(R.string.no_device)
                R.id.radioButtonNoTrackerAvailable -> cancelRequest.reason = getString(R.string.no_tracker_available)
