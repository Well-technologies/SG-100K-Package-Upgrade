...
class StatusCheckDialogFragment : DialogFragment(), Injectable {

    val TAG = StatusCheckDialogFragment::class.java.getSimpleName()


    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory
    var binding by autoCleared<StatusCheckDialogFragmentBinding>()
    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)

    @Inject
    lateinit var viewModel: StatusCheckDialogViewModel
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<StatusCheckDialogFragmentBinding>(
            inflater,
            R.layout.status_check_dialog_fragment,
            container,
            false
        )
        binding = dataBinding
