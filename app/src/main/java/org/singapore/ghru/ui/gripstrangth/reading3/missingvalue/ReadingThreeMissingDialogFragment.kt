package org.singapore.ghru.ui.gripstrangth.reading3.missingvalue
...
import org.singapore.ghru.event.Reading3RecordTestRxBus
import org.singapore.ghru.util.hideKeyboard
import org.singapore.ghru.util.singleClick
import org.singapore.ghru.vo.GripStrengthData

class ReadingThreeMissingDialogFragment : DialogFragment(), Injectable {

    val TAG = ReadingThreeMissingDialogFragment::class.java.getSimpleName()
    ...
    @Inject
    lateinit var missingDialogViewModel: ReadingThreeMissingDialogViewModel

    var readingThreeData : GripStrengthData? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        try {
            readingThreeData = arguments?.getParcelable<GripStrengthData>("readingThreeData")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.continueButton.singleClick {
            if (readingThreeData != null)
            {
                Reading3RecordTestRxBus.getInstance().post(readingThreeData!!)
