...
import org.singapore.ghru.databinding.EcgMaualBarcodeFragmentBinding
            ...
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    ...
                    Navigation.findNavController(activity!!, R.id.container)
                        .navigate(R.id.action_manualFragment_to_guideMainFragment, bundle)
                }, { error ->
                    print(error)
...
//                findNavController().navigate(R.id.action_manualFragment_to_guideMainFragment, bundle)
//            } else if (participantResource?.status == Status.ERROR) {
//                val errorDialogFragment = ErrorDialogFragment()
