...
import org.singapore.ghru.databinding.StrengthFragmentBinding
...
class StrengthFragment : Fragment(), Injectable {
    @Inject
    ...
    var binding by autoCleared<StrengthFragmentBinding>()
    ...
    @Inject
    lateinit var viewModel: StrengthViewModel
    ...
    private var reading2: GripStrengthData? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            reading2 = arguments?.getParcelable<GripStrengthData>("Reading2")!!
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<StrengthFragmentBinding>(
            inflater,
            R.layout.strength_fragment,
            container,
            false
        )
        binding = dataBinding
...
//        binding.hipR1EditText = bodyMeasurementReading1
...
//        bodyMeasurementData = BodyMeasurementDataNew()
        ...
        binding.buttonSubmit.singleClick {
            ...
            if (validateGripReading1(binding.hipR1EditText.text.toString()) && validateGripReading2(binding.hipR2EditText.text.toString()))
            {
                ...
                RightGripRecordTestRxBus.getInstance().post(record)
                binding.root.hideKeyboard()
            ...
            else if (validateGripReading1(binding.hipR1EditText.text.toString()) && !validateGripReading2(binding.hipR2EditText.text.toString()))
            {
                ...
                {
                    val missingDialogFragment = ReadingTwoMissingDialogFragment()
                    missingDialogFragment.arguments = bundleOf(
                        "readingTwoData" to record)
