package org.singapore.ghru.ui.samplecollection.scanbarcode
            ...
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    ...
                    Navigation.findNavController(activity!!, R.id.container)
                        .navigate(R.id.action_scanBarcodeFragment_to_sampleQuestionFragment, bundle)
                }, { error ->
                    print(error)
            ...
            activity?.runOnUiThread {
                ...
                if (!checkSum.error) {
                    ...
                    if (isNetworkAvailable()) {
                        handler.post({ viewModel.setCheckoutScreeningId(screeningID) })
                    } else {
...
//                    R.id.action_scanBarcodeFragment_to_bagScannedFragment,
