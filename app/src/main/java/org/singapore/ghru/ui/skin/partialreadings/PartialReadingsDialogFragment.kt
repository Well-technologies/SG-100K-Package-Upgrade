...
import org.singapore.ghru.databinding.SkinPartialReadingsDialogFragmentBinding
...
class PartialReadingsDialogFragment : DialogFragment(), Injectable {
    ...
    var binding by autoCleared<SkinPartialReadingsDialogFragmentBinding>()
    ...
    private var skinRequest: SkinRequest? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        try {
            participantRequest = arguments?.getParcelable<ParticipantRequest>("participant")!!
            skinRequest = arguments?.getParcelable<SkinRequest>("skinRequest")
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<SkinPartialReadingsDialogFragmentBinding>(
            inflater,
            R.layout.skin_partial_readings_dialog_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (!skinRequest!!.comment.equals(""))
        {
            prComment = skinRequest!!.comment
        ...
        binding.buttonAcceptAndContinue.singleClick {
            ...
            {
                skinRequest!!.meta = participantRequest?.meta
                skinRequest!!.comment = binding.comment.text.toString()

                viewModel.setPostSkin(skinRequest!!, participantRequest?.screeningId)
            }
            else
            {
        ...
        viewModel.skinPostComplete?.observe(this, Observer {
