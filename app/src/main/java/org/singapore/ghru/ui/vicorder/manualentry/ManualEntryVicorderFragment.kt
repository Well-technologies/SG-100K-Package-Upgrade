package org.singapore.ghru.ui.vicorder.manualentry
...
import org.singapore.ghru.databinding.FundoscopyManualBarcodeFragmentBinding
...
import org.singapore.ghru.ui.vicorder.ScanBarcodeViewModel
...
class ManualEntryVicorderFragment : Fragment(), Injectable {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        disposables.add(
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    val bundle = bundleOf("participant" to participantRequest, "BodyMeasurementData" to bodyMeasurementMeta)
                    Navigation.findNavController(activity!!, R.id.container)
                        .navigate(R.id.action_manual_to_contraFragment, bundle)
                }, { error ->
                    print(error)
