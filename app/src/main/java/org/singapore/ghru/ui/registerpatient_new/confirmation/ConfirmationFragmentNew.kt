package org.singapore.ghru.ui.registerpatient_new.confirmation
...
import org.singapore.ghru.databinding.ConfirmationFragmentBinding
import org.singapore.ghru.databinding.ConfirmationFragmentNewBinding
import org.singapore.ghru.databinding.ConfirmationFragmentSgBinding
import org.singapore.ghru.di.Injectable
import org.singapore.ghru.jobs.SyncImageConcentUploadJob
import org.singapore.ghru.jobs.SyncImageUploadJob
import org.singapore.ghru.jobs.SyncparticipantMetaJob
...
class ConfirmationFragmentNew : Fragment(), Injectable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            concentPhoto = "/storage/emulated/0/Android/data/org.singapore.ghru/files/photos/1581779186.jpg"
...
//                    participantMeta?.body?.hoursFasted = "NA"
            ...
            participantRequest.syncPending = !isNetworkAvailable()
        ...
        when (item.getItemId()) {
            android.R.id.home -> {
                findNavController().navigate(
                    R.id.action_global_scanBarcodeFragment, bundleOf("participantMeta" to participantMeta, "concentPhotoPath" to concentPhoto)
                )
            }
        }
        return true
