...
import org.singapore.ghru.databinding.VisualAcuitySkipFragmentBinding
...
class VisualAcuitySkipFragment : DialogFragment() {

    val TAG = VisualAcuitySkipFragment::class.java.getSimpleName()

    var binding by autoCleared<VisualAcuitySkipFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<VisualAcuitySkipFragmentBinding>(
            inflater,
            R.layout.visual_acuity_skip_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(VisualAcuityQuestionnaireViewModel::class.java)
