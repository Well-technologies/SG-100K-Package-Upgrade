package org.singapore.ghru.ui.octa.reading.reason
...
import org.singapore.ghru.databinding.FundocopyReasonDialogFragmentBinding
...
class ReasonDialogFragment : DialogFragment(), Injectable {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        cancelRequest = CancelRequest(stationType = "octa")
        ...
        if (fromSkipped && contraindications != null) {
            binding.radioGroupProblemEye.check(R.id.radioButtonContraindication)
        }
