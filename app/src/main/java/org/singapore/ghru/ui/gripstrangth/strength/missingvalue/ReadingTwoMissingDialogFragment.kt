package org.singapore.ghru.ui.gripstrangth.strength.missingvalue
...
import org.singapore.ghru.event.RightGripRecordTestRxBus
import org.singapore.ghru.util.hideKeyboard
import org.singapore.ghru.util.singleClick
import org.singapore.ghru.vo.GripStrengthData

class ReadingTwoMissingDialogFragment : DialogFragment(), Injectable {

    val TAG = ReadingTwoMissingDialogFragment::class.java.getSimpleName()
    ...
    @Inject
    lateinit var missingDialogViewModel: ReadingTwoMissingDialogViewModel

    var readingTwoData : GripStrengthData? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        try {
            readingTwoData = arguments?.getParcelable<GripStrengthData>("readingTwoData")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.continueButton.singleClick {
            if (readingTwoData != null)
            {
                RightGripRecordTestRxBus.getInstance().post(readingTwoData!!)
