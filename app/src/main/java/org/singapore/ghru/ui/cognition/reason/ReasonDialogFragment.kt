package org.singapore.ghru.ui.cognition.reason
...
class ReasonDialogFragment : DialogFragment(), Injectable {
    ...
    var binding by autoCleared<CognitionReasonDialogFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<CognitionReasonDialogFragmentBinding>(
            inflater,
            R.layout.cognition_reason_dialog_fragment,
            container,
            false
        )
        binding = dataBinding
