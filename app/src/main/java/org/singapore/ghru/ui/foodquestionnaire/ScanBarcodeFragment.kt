package org.singapore.ghru.ui.foodquestionnaire
            ...
            StationCheckRxBus.getInstance().toObservable()
                .subscribe({ result ->
                    ...
                    Navigation.findNavController(activity!!, R.id.container)
                        .navigate(R.id.action_scanBarcodeFragment_to_languageFragment, bundle)
                }, { error ->
                    print(error)
...
//                }
                ...
                if (!participantResource.data.stationStatus)
                {
                    findNavController().navigate(R.id.action_scanBarcodeFragment_to_languageFragment, bundle)
                }
                else {
