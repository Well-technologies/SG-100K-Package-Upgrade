...
class SpiroSkipFragment : DialogFragment() {

    val TAG = SpiroSkipFragment::class.java.getSimpleName()
    ...
    @Inject
    lateinit var viewModel:SpiroSkipViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(SpiroSkipViewModel::class.java)
