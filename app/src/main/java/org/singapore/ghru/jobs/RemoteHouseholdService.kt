...
import org.singapore.ghru.db.NGRHUDb
import org.singapore.ghru.di.StringConverterFactory
...
//    @Throws(IOException::class, RemoteException::class)
//    fun addBodyMeasurementMetaSync(screeningId: String, bodyMeasurementRequest: HeightWeightMeasurementMeta) {
//
//        // Remote call can be executed synchronously since the job calling it is already backgrounded.]
//        val response = service.addBodyMeasurementMetaSync(screeningId, bodyMeasurementRequest).execute()
//
...
//            L.d("error remote response: " + response.toString())
    ...
    @Throws(IOException::class, RemoteException::class)
    fun addDXA(participantRequest: ParticipantRequest?, dxaRequest: DXARequest) {

        // Remote call can be executed synchronously since the job calling it is already backgrounded.]
        val response =
            service.addDXA(participantRequest?.screeningId!!, dxaRequest )
                .execute()
    ...
    @Throws(IOException::class, RemoteException::class)
    fun addUltrasound(participantRequest: ParticipantRequest?, ultrasoundRequest: UltrasoundRequest) {

        // Remote call can be executed synchronously since the job calling it is already backgrounded.]
        val response =
            service.addUltrasound(participantRequest?.screeningId!!, ultrasoundRequest )
                .execute()
    ...
    @Throws(IOException::class, RemoteException::class)
    fun addTreadmill(participantRequest: ParticipantRequest?, treadmillRequest: TreadmillRequest) {

        // Remote call can be executed synchronously since the job calling it is already backgrounded.]
        val response =
            service.addTreadmill(participantRequest?.screeningId!!, treadmillRequest )
                .execute()
