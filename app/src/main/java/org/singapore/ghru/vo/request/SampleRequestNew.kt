...
@Entity(tableName = "sample_request_new")
data class SampleRequestNew(
...
//        parcel.writeLong(id)
    ...
    companion object CREATOR : Parcelable.Creator<SampleRequestNew> {
        override fun createFromParcel(parcel: Parcel): SampleRequestNew {
            return SampleRequestNew(parcel)
        }

        override fun newArray(size: Int): Array<SampleRequestNew?> {
