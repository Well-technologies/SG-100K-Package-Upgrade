...
@Entity(tableName = "octa_request")
data class OctaRequest(
    ...
    companion object CREATOR : Parcelable.Creator<OctaRequest> {
        override fun createFromParcel(parcel: Parcel): OctaRequest {
            return OctaRequest(parcel)
        }

        override fun newArray(size: Int): Array<OctaRequest?> {
