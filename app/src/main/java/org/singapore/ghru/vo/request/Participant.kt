...
data class ParticipantX(
    ...
    @Expose
    @field:SerializedName("other_race")
    @ColumnInfo(name = "other_race")
    var otherRace: String = String()

    @Expose
    @field:SerializedName("last_meal_time")
    @ColumnInfo(name = "last_meal_time")
    var lastMealTime: String = String()
    ...
    constructor(parcel: Parcel) : this(
        ...
        otherRace = parcel.readString()!!
        lastMealTime = parcel.readString()!!
    }
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeString(lastMealTime)
    }
