...
class HeightWeightActivity : BaseActivity(), HasSupportFragmentInjector {
    ...
    override fun onSupportNavigateUp(): Boolean {
        val currentDestination = Navigation.findNavController(this, R.id.height_container).currentDestination
