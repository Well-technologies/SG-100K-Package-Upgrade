...
import org.singapore.ghru.api.AuthAPIService
import org.singapore.ghru.api.NghruService
import org.singapore.ghru.api.NghruServiceLocal
import org.singapore.ghru.db.*
import org.singapore.ghru.jobs.GcmJobService
import org.singapore.ghru.jobs.JobManagerFactory
import org.singapore.ghru.jobs.SchedulerJobService
import org.singapore.ghru.sync.*
import org.singapore.ghru.util.LiveDataCallAdapterFactory
...
class AppModule {
    ...
    @Singleton
    @Provides
    fun provideGripStrengthRequestDao(db: NGRHUDb): GripStrengthRequestDao {
        return db.gripStrengthRequestDao()
    }

    @Singleton
    @Provides
    fun provideHipWaistRequestDao(db: NGRHUDb): HipWaistRequestDao {
        return db.hipWaistRequestDao()
    }

    @Singleton
    @Provides
    fun provideVisualAcuityRequestDao(db: NGRHUDb): VisualAcuityRequestDao {
        return db.visualAcuityRequestDao()
    }

    @Singleton
    @Provides
    fun provideFFQRequestDao(db: NGRHUDb): FFQRequestDao {
        return db.ffqRequestDao()
    }

    @Singleton
    @Provides
    fun provideCognitionRequestDao(db: NGRHUDb): CognitionRequestDao {
        return db.cognitionRequestDao()
    }
...
//    }
    ...
    @Singleton
    @Provides
    fun provideDXARequestDao(db: NGRHUDb): DXARequestDao {
        return db.dxaRequestDao()
    }

    @Singleton
    @Provides
    fun provideUltrasoundRequestDao(db: NGRHUDb): UltrasoundRequestDao {
        return db.ultrasoundRequestDao()
    }

    @Singleton
    @Provides
    fun provideTreadmillRequestDao(db: NGRHUDb): TreadmillRequestDao {
        return db.treadmillRequestDao()
    }
}
